...
\begin{titlepage}
	...
	\begin{center}
		...
		\end{Large}
		 	{\Huge ``Elaboración de un ranking de
                        consumidores de electricidad según sus
                        dependencias de variables
                        meteorológicas''}\\
		 	\vspace*{0.5cm}
	 		\rule{10.5cm}{0.1mm}\\
			\vspace*{0.9cm}
			{\LARGE Marc Pastor Pou}\\ 
			\vspace*{1cm}
		\begin{Large}
			Tutor/es\\
...
\chapter{Introducción}
    \LaTeX{} \cite{dirac} is a set of macros built atop \TeX{} \cite{texbook}.
